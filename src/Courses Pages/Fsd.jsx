...
export default function Fsd() {
    ...
    const handleDownload = () => {
        const pdfPath = '/SyllabusPdf/FSD-Syllabus.pdf'; // Path to your PDF file inside the public folder
        const link = document.createElement('a');
        link.href = pdfPath;
        link.download = 'Full Stack Development Syllabus.pdf';
        ...
        <div className='py-[80px]'>
            <section className='py-4 lg:py-[48px] px-5 lg:px-[100px] flex flex-col lg:flex-row justify-between gap-[64px] min-h-[606px]'>
                <div className=' lg:w-[543px] min-h-[348px]'>
                    <h2 className='text-[36px] font-bold leading-[48px] min-h-[43px] capitalize mb-4'>full Stack Development</h2>
                    <p className='lg:w-[543px] min-h-[95px] text-[16px] leading-[19px] text-justify text-[#1b1c1e] mb-4'>Our Full Stack Development course is a comprehensive program that covers the skills and knowledge required to become a proficient web developer. The course is designed for students who have little to no experience in web development but want to learn how to create dynamic and responsive websites.</p>
                ...
                <div className='w-[370px] h-[300px] lg:w-[633px] lg:h-[510px] bg-FSDI1 bg-cover' data-aos="fade-left" data-aos-duration="1500">
