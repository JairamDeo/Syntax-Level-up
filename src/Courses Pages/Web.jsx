        ...
        <div className='py-[80px]'>
            <section className='py-4 lg:py-[48px] px-5 lg:px-[100px] flex flex-col lg:flex-row justify-between gap-[64px] min-h-[606px]'>
                <div className=' lg:w-[543px] min-h-[348px]'>
                    <h2 className='text-[36px] font-bold leading-[48px] min-h-[43px] capitalize mb-4'>Web Development</h2>
                    <p className='lg:w-[543px] min-h-[95px] text-[16px] leading-[19px] text-justify text-[#1b1c1e] mb-4'>Our Web Development course is a comprehensive program that covers the skills and knowledge required to become a proficient web developer. The course is designed for students who have little to no experience in web development but want to learn how to create dynamic and responsive websites.</p>
                ...
                <div className='w-[370px] h-[300px] lg:w-[633px] lg:h-[510px] bg-WEBI1 bg-cover' data-aos="fade-left" data-aos-duration="1500">
