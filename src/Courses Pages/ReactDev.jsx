        ...
        <div className='py-[80px]'>
            <section className='py-4 lg:py-[48px] px-5 lg:px-[100px] flex flex-col lg:flex-row justify-between gap-[64px] min-h-[606px]'>
                <div className=' lg:w-[543px] min-h-[348px]'>
                    <h2 className='text-[36px] font-bold leading-[48px] min-h-[43px] capitalize mb-4'>React Development</h2>
                    <p className='lg:w-[543px] min-h-[95px] text-[16px] leading-[19px] text-justify text-[#1b1c1e] mb-4'>Our React Development course is a comprehensive program that covers the skills and knowledge required to become a proficient web developer. The course is designed for students who have little to no experience in web development but want to learn how to create dynamic and responsive websites.</p>
                    ...
                    <div className='flex flex-row  min-h-[84px] items-center gap-2 py-5'>
                        ...
                        <div className='lg:w-[258px] lg:h-[34px] rounded-[100px] border-2 border-[rgb(56,210,0)] text-[16px] font-bold text-[#1B1C1E] text-center hover:bg-[#38D200] hover:text-white duration-700 p-1'><span><i className="fa-solid fa-diagram-project"></i></span>&ensp;Real world Projects</div>
                    </div>
                ...
                <div className='w-[370px] h-[300px] lg:w-[633px] lg:h-[510px] bg-REACTI1 bg-cover' data-aos="fade-left" data-aos-duration="1500">
