...
export default function About() {
    ...
    return (
        <div>
            <div className='py-[120px] px-5 lg:px-[100px]'>
                ...
                <div className='lg:-[930px] grid grid-cols-1 lg:grid-cols-3 justify-between gap-[40px] mx-auto'>
                    {cards.map((card, index) => (
                        <div key={index} className='w-[290px] min-h-[317px]'>
            ...
            <div className='py-5 lg:py-[80px] grid grid-cols-2 lg:grid-cols-4 w-full h-[300px] lg:h-[250px] bg-[#07294D] justify-around items-center mx-auto mb-3'>
