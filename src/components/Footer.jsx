      ...
      <footer className='lg:h-[450px] gap-[48px]'>
        <main className='min-h-[368px] lg:h-[368px] px-5 sm:px-[50px] lg:px-[100px] w-[100%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[40px]  bg-[#000F9A] py-[60px]'>
          <container className='w-[210px] h-[212px] flex flex-col gap-[25px] lg:gap-[72px]'>
            ...
            <div className='flex flex-col gap-3'>
              ...
              <div className='flex flex-row gap-4'>
                <Link className='w-[48px] h-[48px] border-2 border-white rounded-full flex justify-center items-center hover:bg-[orange] cursor-pointer duration-700' data-aos="flip-left" data-aos-duration="1500">
                  <i className="fa-brands fa-google text-[white] text-[1.7rem]"></i>
                </Link>
                <Link className='w-[48px] h-[48px] border-2 border-white rounded-full flex justify-center items-center hover:bg-[orange] cursor-pointer duration-700' data-aos="flip-left" data-aos-duration="2000">
                  <i className="fa-brands fa-instagram text-[white] text-[1.7rem]"></i>
                </Link>
                <Link className='w-[48px] h-[48px] border-2 border-white rounded-full flex justify-center items-center hover:bg-[orange] cursor-pointer duration-700' data-aos="flip-left" data-aos-duration="2500">
          ...
          <container className='foot w-[155px] h-[256px] flex flex-col gap-[24px]'>
            ...
            <div className='flex flex-col gap-[8px] text-white w-[127px] h-[198px] text-[18px]'>
              <div className='flex flex-row gap-2 hover:text-[#40E0D0] duration-700'>
                <i className="fa-regular fa-envelope p-1"></i><Link>courseconnect@gmail.com</Link>
              </div>
              <div className='flex flex-row w-[176px] gap-2 hover:text-[#40E0D0] duration-700'>
          ...
          <container className='foot w-[140px] h-[256px] flex flex-col gap-[24px]'>
            ...
            <div className='flex flex-row gap-[8px] text-white text-[18px] w-[365px] h-[198px] hover:text-[#40E0D0] duration-700'>
